  ...
  return (
    <div className="space-y-4">
      ...
      <TextareaFieldSkeleton
        labelText="URIs to Exclude from Caching"
        labelWidth="w-2/5"
      />

      {/* Skeleton for "Query Strings to Exclude from Caching" */}
      <TextareaFieldSkeleton
        labelText="Query Strings to Exclude from Caching"
        labelWidth="w-3/5"
      />

      {/* Skeleton for "Cookies to Exclude from Caching" */}
      <TextareaFieldSkeleton
        labelText="Cookies to Exclude from Caching"
        labelWidth="w-2/5"
      />
      ...
      <div className="pt-2">
        {" "}
        {/* Added slight padding to visually separate, optional */}
